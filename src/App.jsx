    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight"></span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Ansh's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Your love 💖</h2>
          <p className="final-subtitle"> Cheers!!✨</p>
        </section>
      </div>
